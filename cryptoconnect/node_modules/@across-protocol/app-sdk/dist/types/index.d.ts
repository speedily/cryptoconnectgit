import { Account, Address, Chain, GetEventArgs, Hash, Hex, PublicClient, Transport, WalletClient } from "viem";
...
export type CrossChainAction = {
    ...
    callData: Hex;
    value: Amount;
    update?: ((outputAmount: bigint) => Promise<{
        callData?: Hex;
        value?: bigint;
    }>) | ((outputAmount: bigint) => {
        callData?: Hex;
...
type MaybeFilledV3RelayEvent = GetEventArgs<typeof spokePoolAbiV3, "FilledV3Relay", {
    IndexedOnly: false;
}>;
type MaybeFilledRelayEvent = GetEventArgs<typeof spokePoolAbiV3_5, "FilledRelay", {
    IndexedOnly: false;
}>;
type MaybeDepositV3Event = GetEventArgs<typeof spokePoolAbiV3, "V3FundsDeposited", {
    IndexedOnly: false;
}>;
type MaybeDepositEvent = GetEventArgs<typeof spokePoolAbiV3_5, "FundsDeposited", {
    IndexedOnly: false;
}>;
