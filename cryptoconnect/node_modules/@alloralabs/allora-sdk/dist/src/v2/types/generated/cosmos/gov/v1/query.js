...
function createBaseQueryProposalVoteOptionsRequest() {
    return { proposalId: "0" };
}
exports.QueryProposalVoteOptionsRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.proposalId !== "0") {
            writer.uint32(8).uint64(message.proposalId);
        }
    ...
    create(base) {
        return exports.QueryProposalVoteOptionsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryProposalVoteOptionsRequest();
...
function createBaseQueryProposalVoteOptionsResponse() {
    return { voteOptions: undefined };
}
exports.QueryProposalVoteOptionsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.voteOptions !== undefined) {
            gov_1.ProposalVoteOptions.encode(message.voteOptions, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return { voteOptions: isSet(object.voteOptions) ? gov_1.ProposalVoteOptions.fromJSON(object.voteOptions) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.voteOptions !== undefined) {
    ...
    create(base) {
        return exports.QueryProposalVoteOptionsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryProposalVoteOptionsResponse();
...
function createBaseQueryMessageBasedParamsRequest() {
    return { msgUrl: "" };
}
exports.QueryMessageBasedParamsRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.msgUrl !== "") {
    ...
    create(base) {
        return exports.QueryMessageBasedParamsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryMessageBasedParamsRequest();
        message.msgUrl = (_a = object.msgUrl) !== null && _a !== void 0 ? _a : "";
        return message;
    },
};
function createBaseQueryMessageBasedParamsResponse() {
    return { params: undefined };
}
exports.QueryMessageBasedParamsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.params !== undefined) {
            gov_1.MessageBasedParams.encode(message.params, writer.uint32(10).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromJSON(object) {
        return { params: isSet(object.params) ? gov_1.MessageBasedParams.fromJSON(object.params) : undefined };
    },
    toJSON(message) {
        const obj = {};
        if (message.params !== undefined) {
    ...
    create(base) {
        return exports.QueryMessageBasedParamsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryMessageBasedParamsResponse();
        message.params = (object.params !== undefined && object.params !== null)
...
class QueryClientImpl {
    ...
    Deposit(request) {
        ...
        return promise.then((data) => exports.QueryDepositResponse.decode(new wire_1.BinaryReader(data)));
    }
    Deposits(request) {
        const data = exports.QueryDepositsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Deposits", data);
        return promise.then((data) => exports.QueryDepositsResponse.decode(new wire_1.BinaryReader(data)));
    }
    TallyResult(request) {
        ...
        return promise.then((data) => exports.QueryTallyResultResponse.decode(new wire_1.BinaryReader(data)));
    }
    ProposalVoteOptions(request) {
        const data = exports.QueryProposalVoteOptionsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "ProposalVoteOptions", data);
        return promise.then((data) => exports.QueryProposalVoteOptionsResponse.decode(new wire_1.BinaryReader(data)));
    }
    MessageBasedParams(request) {
        const data = exports.QueryMessageBasedParamsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "MessageBasedParams", data);
        return promise.then((data) => exports.QueryMessageBasedParamsResponse.decode(new wire_1.BinaryReader(data)));
    }
}
