...
exports.MsgClientImpl = exports.MsgServiceName = exports.MsgPruneExpiredGrantsResponse = exports.MsgPruneExpiredGrants = exports.MsgRevokeResponse = exports.MsgRevoke = exports.MsgExecResponse = exports.MsgExec = exports.MsgGrantResponse = exports.MsgGrant = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.MsgPruneExpiredGrants = {
    ...
    create(base) {
        return exports.MsgPruneExpiredGrants.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseMsgPruneExpiredGrants();
...
exports.MsgPruneExpiredGrantsResponse = {
    encode(_, writer = new wire_1.BinaryWriter()) {
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.MsgPruneExpiredGrantsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseMsgPruneExpiredGrantsResponse();
        return message;
...
class MsgClientImpl {
    ...
    Grant(request) {
        ...
        return promise.then((data) => exports.MsgGrantResponse.decode(new wire_1.BinaryReader(data)));
    }
    Exec(request) {
        const data = exports.MsgExec.encode(request).finish();
        const promise = this.rpc.request(this.service, "Exec", data);
        return promise.then((data) => exports.MsgExecResponse.decode(new wire_1.BinaryReader(data)));
    }
    Revoke(request) {
        const data = exports.MsgRevoke.encode(request).finish();
        const promise = this.rpc.request(this.service, "Revoke", data);
        return promise.then((data) => exports.MsgRevokeResponse.decode(new wire_1.BinaryReader(data)));
    }
    PruneExpiredGrants(request) {
        const data = exports.MsgPruneExpiredGrants.encode(request).finish();
        const promise = this.rpc.request(this.service, "PruneExpiredGrants", data);
        return promise.then((data) => exports.MsgPruneExpiredGrantsResponse.decode(new wire_1.BinaryReader(data)));
    }
}
