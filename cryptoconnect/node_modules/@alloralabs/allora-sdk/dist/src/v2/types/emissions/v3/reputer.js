...
exports.ReputerValueBundles = exports.ReputerValueBundle = exports.ValueBundle = exports.OneOutInfererForecasterValues = exports.WithheldWorkerAttributedValue = exports.WorkerAttributedValue = exports.protobufPackage = void 0;
/* eslint-disable */
...
function createBaseOneOutInfererForecasterValues() {
    return { forecaster: "", oneOutInfererValues: [] };
}
exports.OneOutInfererForecasterValues = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.forecaster !== "") {
            writer.uint32(26).string(message.forecaster);
        }
        for (const v of message.oneOutInfererValues) {
            exports.WithheldWorkerAttributedValue.encode(v, writer.uint32(34).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
    ...
    toJSON(message) {
        ...
        if ((_a = message.oneOutInfererValues) === null || _a === void 0 ? void 0 : _a.length) {
            obj.oneOutInfererValues = message.oneOutInfererValues.map((e) => exports.WithheldWorkerAttributedValue.toJSON(e));
        }
        return obj;
    },
    create(base) {
        return exports.OneOutInfererForecasterValues.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseOneOutInfererForecasterValues();
        message.forecaster = (_a = object.forecaster) !== null && _a !== void 0 ? _a : "";
        message.oneOutInfererValues =
            ((_b = object.oneOutInfererValues) === null || _b === void 0 ? void 0 : _b.map((e) => exports.WithheldWorkerAttributedValue.fromPartial(e))) || [];
        return message;
    },
};
...
exports.ValueBundle = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.oneOutInfererForecasterValues) {
            exports.OneOutInfererForecasterValues.encode(v, writer.uint32(98).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 12: {
                    ...
                    message.oneOutInfererForecasterValues.push(exports.OneOutInfererForecasterValues.decode(reader, reader.uint32()));
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            oneInForecasterValues: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.oneInForecasterValues)
                ...
                : [],
            oneOutInfererForecasterValues: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.oneOutInfererForecasterValues)
                ? object.oneOutInfererForecasterValues.map((e) => exports.OneOutInfererForecasterValues.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_f = message.oneOutInfererForecasterValues) === null || _f === void 0 ? void 0 : _f.length) {
            obj.oneOutInfererForecasterValues = message.oneOutInfererForecasterValues.map((e) => exports.OneOutInfererForecasterValues.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.oneOutInfererForecasterValues =
            ((_l = object.oneOutInfererForecasterValues) === null || _l === void 0 ? void 0 : _l.map((e) => exports.OneOutInfererForecasterValues.fromPartial(e))) || [];
        return message;
    },
};
