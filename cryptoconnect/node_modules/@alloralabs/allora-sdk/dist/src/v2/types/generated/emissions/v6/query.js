...
exports.protobufPackage = "emissions.v6";
...
function createBaseCanUpdateGlobalWhitelistsRequest() {
    return { address: "" };
}
exports.CanUpdateGlobalWhitelistsRequest = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.address !== "") {
            writer.uint32(10).string(message.address);
        }
    ...
    create(base) {
        return exports.CanUpdateGlobalWhitelistsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseCanUpdateGlobalWhitelistsRequest();
...
function createBaseCanUpdateGlobalWhitelistsResponse() {
    return { canUpdateGlobalWhitelists: false };
}
exports.CanUpdateGlobalWhitelistsResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.CanUpdateGlobalWhitelistsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseCanUpdateGlobalWhitelistsResponse();
        message.canUpdateGlobalWhitelists = (_a = object.canUpdateGlobalWhitelists) !== null && _a !== void 0 ? _a : false;
        return message;
    },
};
...
exports.QueryServiceServiceName = "emissions.v6.QueryService";
class QueryServiceClientImpl {
    ...
    CanUpdateGlobalWhitelists(request) {
        const data = exports.CanUpdateGlobalWhitelistsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "CanUpdateGlobalWhitelists", data);
        return promise.then((data) => exports.CanUpdateGlobalWhitelistsResponse.decode(new wire_1.BinaryReader(data)));
    }
