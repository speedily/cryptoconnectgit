...
exports.TxBody = {
    ...
    fromPartial(object) {
        ...
        message.unordered = (_d = object.unordered) !== null && _d !== void 0 ? _d : false;
        message.extensionOptions = ((_e = object.extensionOptions) === null || _e === void 0 ? void 0 : _e.map((e) => any_1.Any.fromPartial(e))) || [];
        message.nonCriticalExtensionOptions = ((_f = object.nonCriticalExtensionOptions) === null || _f === void 0 ? void 0 : _f.map((e) => any_1.Any.fromPartial(e))) || [];
        return message;
    },
};
