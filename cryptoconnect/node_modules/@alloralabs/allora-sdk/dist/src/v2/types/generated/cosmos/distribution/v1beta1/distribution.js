...
exports.FeePool = {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    ...
                    message.decimalPool.push(coin_1.DecCoin.decode(reader, reader.uint32()));
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            communityPool: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.communityPool)
                ...
                : [],
            decimalPool: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.decimalPool)
                ? object.decimalPool.map((e) => coin_1.DecCoin.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_b = message.decimalPool) === null || _b === void 0 ? void 0 : _b.length) {
            obj.decimalPool = message.decimalPool.map((e) => coin_1.DecCoin.toJSON(e));
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.decimalPool = ((_b = object.decimalPool) === null || _b === void 0 ? void 0 : _b.map((e) => coin_1.DecCoin.fromPartial(e))) || [];
        return message;
    },
};
