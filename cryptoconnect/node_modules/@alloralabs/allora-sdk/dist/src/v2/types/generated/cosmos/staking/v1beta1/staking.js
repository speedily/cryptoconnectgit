...
exports.ValAddrsOfRotatedConsKeys = exports.ConsPubKeyRotationHistory = exports.ValidatorUpdates = exports.Pool = exports.RedelegationResponse = exports.RedelegationEntryResponse = exports.DelegationResponse = exports.Params = exports.Redelegation = exports.RedelegationEntry = exports.UnbondingDelegationEntry = exports.UnbondingDelegation = exports.Delegation = exports.DVVTriplets = exports.DVVTriplet = exports.DVPairs = exports.DVPair = exports.ValAddresses = exports.Validator = exports.Description = exports.Commission = exports.CommissionRates = exports.HistoricalRecord = exports.HistoricalInfo = exports.Infraction = exports.BondStatus = exports.protobufPackage = void 0;
...
exports.HistoricalRecord = {
    ...
    create(base) {
        return exports.HistoricalRecord.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBaseHistoricalRecord();
        ...
        message.validatorsHash = (_c = object.validatorsHash) !== null && _c !== void 0 ? _c : new Uint8Array(0);
        return message;
    },
};
    ...
    fromJSON(object) {
        return {
            ...
            unbondingOnHoldRefCount: isSet(object.unbondingOnHoldRefCount)
                ...
                : "0",
            unbondingIds: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.unbondingIds)
                ? object.unbondingIds.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if ((_a = message.unbondingIds) === null || _a === void 0 ? void 0 : _a.length) {
...
exports.Params = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        if (message.keyRotationFee !== undefined) {
            coin_1.Coin.encode(message.keyRotationFee, writer.uint32(58).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 7: {
                    ...
                    message.keyRotationFee = coin_1.Coin.decode(reader, reader.uint32());
                    continue;
                }
            }
            if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object) {
        return {
            ...
            keyRotationFee: isSet(object.keyRotationFee) ? coin_1.Coin.fromJSON(object.keyRotationFee) : undefined,
        };
    },
    toJSON(message) {
        const obj = {};
        ...
        if (message.keyRotationFee !== undefined) {
            obj.keyRotationFee = coin_1.Coin.toJSON(message.keyRotationFee);
        }
        return obj;
    },
    create(base) {
    ...
    fromPartial(object) {
        ...
        message.keyRotationFee = (object.keyRotationFee !== undefined && object.keyRotationFee !== null)
            ? coin_1.Coin.fromPartial(object.keyRotationFee)
            : undefined;
        return message;
    },
};
...
function createBaseConsPubKeyRotationHistory() {
    return {
...
exports.ConsPubKeyRotationHistory = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.operatorAddress.length !== 0) {
            writer.uint32(10).bytes(message.operatorAddress);
        }
        if (message.oldConsPubkey !== undefined) {
            any_1.Any.encode(message.oldConsPubkey, writer.uint32(18).fork()).join();
        }
        if (message.newConsPubkey !== undefined) {
            any_1.Any.encode(message.newConsPubkey, writer.uint32(26).fork()).join();
        }
        if (message.height !== "0") {
            writer.uint32(32).uint64(message.height);
        }
        if (message.fee !== undefined) {
            coin_1.Coin.encode(message.fee, writer.uint32(42).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 2: {
                    ...
                    message.oldConsPubkey = any_1.Any.decode(reader, reader.uint32());
                    continue;
                }
                case 3: {
                    if (tag !== 26) {
                    ...
                    message.newConsPubkey = any_1.Any.decode(reader, reader.uint32());
                    continue;
                }
                case 4: {
                    if (tag !== 32) {
    ...
    fromJSON(object) {
        return {
            ...
            oldConsPubkey: isSet(object.oldConsPubkey) ? any_1.Any.fromJSON(object.oldConsPubkey) : undefined,
            newConsPubkey: isSet(object.newConsPubkey) ? any_1.Any.fromJSON(object.newConsPubkey) : undefined,
    ...
    toJSON(message) {
        ...
        if (message.oldConsPubkey !== undefined) {
            obj.oldConsPubkey = any_1.Any.toJSON(message.oldConsPubkey);
        }
        if (message.newConsPubkey !== undefined) {
            obj.newConsPubkey = any_1.Any.toJSON(message.newConsPubkey);
        }
        if (message.height !== "0") {
    ...
    create(base) {
        return exports.ConsPubKeyRotationHistory.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseConsPubKeyRotationHistory();
        message.operatorAddress = (_a = object.operatorAddress) !== null && _a !== void 0 ? _a : new Uint8Array(0);
        message.oldConsPubkey = (object.oldConsPubkey !== undefined && object.oldConsPubkey !== null)
            ? any_1.Any.fromPartial(object.oldConsPubkey)
            : undefined;
        message.newConsPubkey = (object.newConsPubkey !== undefined && object.newConsPubkey !== null)
            ? any_1.Any.fromPartial(object.newConsPubkey)
            : undefined;
...
function createBaseValAddrsOfRotatedConsKeys() {
    return { addresses: [] };
}
exports.ValAddrsOfRotatedConsKeys = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.ValAddrsOfRotatedConsKeys.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseValAddrsOfRotatedConsKeys();
