...
class ServiceClientImpl {
    ...
    GetBlockWithTxs(request) {
        ...
        return promise.then((data) => exports.GetBlockWithTxsResponse.decode(new wire_1.BinaryReader(data)));
    }
    TxDecode(request) {
        const data = exports.TxDecodeRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "TxDecode", data);
        return promise.then((data) => exports.TxDecodeResponse.decode(new wire_1.BinaryReader(data)));
    }
    TxEncode(request) {
        const data = exports.TxEncodeRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "TxEncode", data);
        return promise.then((data) => exports.TxEncodeResponse.decode(new wire_1.BinaryReader(data)));
    }
    TxEncodeAmino(request) {
        ...
        return promise.then((data) => exports.TxEncodeAminoResponse.decode(new wire_1.BinaryReader(data)));
    }
    TxDecodeAmino(request) {
        ...
        return promise.then((data) => exports.TxDecodeAminoResponse.decode(new wire_1.BinaryReader(data)));
    }
}
