...
import { type UpgradeKernelParameters } from "../../actions/account-client/upgradeKernel.js";
import { writeContract } from "../../actions/account-client/writeContract.js";
import type { ChangeSudoValidatorParameters, SignUserOperationReturnType, UninstallPluginParameters } from "../../actions/index.js";
...
export declare const zerodevPaymasterActions: <entryPointVersion extends EntryPointVersion>() => (client: Client) => ZeroDevPaymasterClientActions;
export type KernelAccountClientActions<TChain extends Chain | undefined = Chain | undefined, TSmartAccount extends SmartAccount | undefined = SmartAccount | undefined> = {
     ...
     */
    signUserOperation: <accountOverride extends SmartAccount | undefined = undefined, calls extends readonly unknown[] = readonly unknown[]>(args: Parameters<typeof signUserOperation<TSmartAccount, TChain, accountOverride, calls>>[1]) => Promise<SignUserOperationReturnType>;
    /**
     ...
     */
    uninstallPlugin: <accountOverride extends SmartAccount | undefined = undefined, calls extends readonly unknown[] = readonly unknown[]>(args: UninstallPluginParameters<TSmartAccount, accountOverride, calls>) => Promise<Hash>;
    /**
     * Creates, signs, and sends a user operation to change sudo validator to the network.
     * This function also allows you to sponsor this transaction if sender is a smartAccount
     */
    changeSudoValidator: <accountOverride extends SmartAccount | undefined = undefined, calls extends readonly unknown[] = readonly unknown[]>(args: ChangeSudoValidatorParameters<TSmartAccount, accountOverride, calls>) => Promise<Hash>;
    /**
     ...
     * @returns The [Transaction](https://viem.sh/docs/glossary/terms.html#transaction) hash. {@link SendTransactionReturnType}
     */
    invalidateNonce: <accountOverride extends SmartAccount | undefined = undefined, calls extends readonly unknown[] = readonly unknown[]>(args: InvalidateNonceParameters<TSmartAccount, accountOverride, calls>) => Promise<Hash>;
    /**
     ...
     * @returns The [Transaction](https://viem.sh/docs/glossary/terms.html#transaction) hash. {@link SendTransactionReturnType}
     */
    upgradeKernel: <accountOverride extends SmartAccount | undefined = undefined, calls extends readonly unknown[] = readonly unknown[]>(args: UpgradeKernelParameters<TSmartAccount, accountOverride, calls>) => Promise<Hash>;
    /**
...
export declare function kernelAccountClientActions(): <TChain extends Chain | undefined = Chain | undefined, TSmartAccount extends SmartAccount | undefined = SmartAccount | undefined>(client: Client<Transport, TChain, TSmartAccount>) => KernelAccountClientActions<TChain, TSmartAccount>;
