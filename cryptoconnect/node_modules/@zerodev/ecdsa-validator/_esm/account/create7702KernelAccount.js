import { KERNEL_FEATURES, accountMetadata, eip712WrapHash, encodeCallDataEpV06, encodeCallDataEpV07, encodeDeployCallDataV06, encodeDeployCallDataV07, hasKernelFeature, toSigner, validateKernelVersionWithEntryPoint } from "@zerodev/sdk";
...
import { KernelVersionToAddressesMap, MAGIC_VALUE_SIG_REPLAYABLE } from "@zerodev/sdk/constants";
import { concatHex, createNonceManager, getTypesForEIP712Domain, hashMessage, hashTypedData, isAddressEqual, validateTypedData, zeroAddress } from "viem";
 ...
 * @param address
 */
export async function create7702KernelAccount(client, { signer, plugins, entryPoint, accountImplementationAddress: _accountImplementationAddress, kernelVersion, pluginMigrations, eip7702Auth }) {
    ...
    const signAuthorization = async () => {
        ...
        if (!code ||
            ...
            if (eip7702Auth && !isAddressEqual(eip7702Auth.address, accountImplementationAddress)) {
