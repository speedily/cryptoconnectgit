...
export type Create7702KernelAccountClientParameters = Omit<SmartAccountClientConfig<Transport, Chain | undefined, SmartAccount<KernelSmartAccount7702Implementation<"0.7">>, Client | undefined, RpcSchema | undefined>, "account"> & {
    account: SmartAccount<KernelSmartAccount7702Implementation<"0.7">>;
};
export declare function create7702KernelAccountClient(parameters: Create7702KernelAccountClientParameters): import("@zerodev/sdk/clients").KernelAccountClient<Transport, Chain | undefined, (object & {
    client: Client<Transport, Chain | undefined, {
        ...
        signAuthorization?: ((parameters: import("viem/_types/types/authorization.js").AuthorizationRequest) => Promise<import("viem/accounts").SignAuthorizationReturnType>) | undefined;
        signMessage: ({ message }: {
    ...
    getStubSignature: (parameters?: import("viem/account-abstraction").UserOperationRequest | undefined) => Promise<`0x${string}`>;
    ...
    userOperation?: {
        estimateGas?: ((userOperation: import("viem/account-abstraction").UserOperationRequest) => Promise<import("viem").ExactPartial<import("viem/_types/account-abstraction/types/userOperation.js").EstimateUserOperationGasReturnType> | undefined>) | undefined;
    } | undefined;
    ...
    authorization: {
        account: {
            ...
            signAuthorization: (parameters: import("viem/_types/types/authorization.js").AuthorizationRequest) => Promise<import("viem/accounts").SignAuthorizationReturnType>;
            signMessage: ({ message }: {
                message: import("viem").SignableMessage;
            }) => Promise<`0x${string}`>;
            signTransaction: <serializer extends import("viem").SerializeTransactionFn<import("viem").TransactionSerializable> = import("viem").SerializeTransactionFn<import("viem").TransactionSerializable>, transaction extends Parameters<serializer>[0] = Parameters<serializer>[0]>(transaction: transaction, options?: {
    ...
    isDeployed: () => Promise<boolean>;
    type: "smart";
}), Client | undefined, RpcSchema>;
//# sourceMappingURL=kernel7702AccountClient.d.ts.map