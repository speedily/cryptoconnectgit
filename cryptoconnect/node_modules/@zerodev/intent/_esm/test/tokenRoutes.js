...
import { arbitrum, base, baseSepolia, bsc, mainnet, optimism, sepolia, } from "viem/chains";
export const SEPOLIA_TOKEN_ROUTES = {
    chain: sepolia,
    routes: [
        // NATIVE
        {
...
export const BASE_SEPOLIA_TOKEN_ROUTES = {
    chain: baseSepolia,
    routes: [
        // NATIVE
        {
...
export const BASE_TOKEN_ROUTES = {
    chain: base,
    routes: [
        // NATIVE
        {
...
export const MAINNET_TOKEN_ROUTES_SAME_CHAIN = [
    {
        chain: mainnet,
        routes: [
            {
...
export const TESTNET_TOKEN_ROUTES = [
    SEPOLIA_TOKEN_ROUTES,
    BASE_SEPOLIA_TOKEN_ROUTES,
];
export const MAINNET_TOKEN_ROUTES = [
    ETH_TOKEN_ROUTES,
    OP_TOKEN_ROUTES,
    ARB_TOKEN_ROUTES,
    BASE_TOKEN_ROUTES,
