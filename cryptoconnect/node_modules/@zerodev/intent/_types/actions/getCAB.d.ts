 ...
 */
export declare function getCAB<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends SmartAccount | undefined = SmartAccount | undefined>(client: Client<transport, chain, account, CombinedIntentRpcSchema>, parameters: GetCABParameters): Promise<GetCABResult>;
export {};
//# sourceMappingURL=getCAB.d.ts.map