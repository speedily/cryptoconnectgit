 ...
 */
export declare function getUserIntentStatus<transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, account extends SmartAccount | undefined = SmartAccount | undefined>(client: Client<transport, chain, account, CombinedIntentRpcSchema>, parameters: GetUserIntentStatusParameters, version: INTENT_VERSION_TYPE): Promise<GetUserIntentStatusResult>;
//# sourceMappingURL=getUserIntentStatus.d.ts.map