...
exports.QueryValidatorDistributionInfoResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            selfBondRewards: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.selfBondRewards)
    ...
    toJSON(message) {
        ...
        if ((_a = message.selfBondRewards) === null || _a === void 0 ? void 0 : _a.length) {
            obj.selfBondRewards = message.selfBondRewards.map((e) => coin_1.DecCoin.toJSON(e));
        }
        if ((_b = message.commission) === null || _b === void 0 ? void 0 : _b.length) {
...
exports.QueryValidatorSlashesResponse = {
    ...
    fromJSON(object) {
        return {
            slashes: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.slashes)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.slashes) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    fromJSON(object) {
        return {
            rewards: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.rewards)
                ...
                : [],
            total: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.total) ? object.total.map((e) => coin_1.DecCoin.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        var _a, _b;
        ...
        if ((_b = message.total) === null || _b === void 0 ? void 0 : _b.length) {
...
class QueryClientImpl {
    ...
    ValidatorDistributionInfo(request) {
        ...
        return promise.then((data) => exports.QueryValidatorDistributionInfoResponse.decode(new wire_1.BinaryReader(data)));
    }
    ValidatorOutstandingRewards(request) {
        ...
        return promise.then((data) => exports.QueryValidatorOutstandingRewardsResponse.decode(new wire_1.BinaryReader(data)));
    }
    ValidatorCommission(request) {
        ...
        return promise.then((data) => exports.QueryValidatorCommissionResponse.decode(new wire_1.BinaryReader(data)));
    }
    ValidatorSlashes(request) {
        ...
        return promise.then((data) => exports.QueryValidatorSlashesResponse.decode(new wire_1.BinaryReader(data)));
    }
    DelegationRewards(request) {
        ...
        return promise.then((data) => exports.QueryDelegationRewardsResponse.decode(new wire_1.BinaryReader(data)));
    }
    DelegationTotalRewards(request) {
        ...
        return promise.then((data) => exports.QueryDelegationTotalRewardsResponse.decode(new wire_1.BinaryReader(data)));
    }
