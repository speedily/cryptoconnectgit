...
exports.QueryAllowancesResponse = {
    ...
    fromJSON(object) {
        return {
            allowances: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.allowances)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.allowances) === null || _a === void 0 ? void 0 : _a.length) {
...
class QueryClientImpl {
    ...
    Allowance(request) {
        ...
        return promise.then((data) => exports.QueryAllowanceResponse.decode(new wire_1.BinaryReader(data)));
    }
    Allowances(request) {
        ...
        return promise.then((data) => exports.QueryAllowancesResponse.decode(new wire_1.BinaryReader(data)));
    }
    AllowancesByGranter(request) {
        ...
        return promise.then((data) => exports.QueryAllowancesByGranterResponse.decode(new wire_1.BinaryReader(data)));
    }
}
