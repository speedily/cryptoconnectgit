...
exports.GenesisState = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        ...
        for (const v of message.latestInfererScoresByWorker) {
            exports.TopicIdActorIdScore.encode(v, writer.uint32(106).fork()).join();
        }
        for (const v of message.latestForecasterScoresByWorker) {
            exports.TopicIdActorIdScore.encode(v, writer.uint32(114).fork()).join();
        }
        for (const v of message.latestReputerScoresByReputer) {
            exports.TopicIdActorIdScore.encode(v, writer.uint32(122).fork()).join();
        }
        ...
        for (const v of message.previousForecasterScoreRatio) {
            exports.TopicIdActorIdDec.encode(v, writer.uint32(162).fork()).join();
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 13: {
                    ...
                    message.latestInfererScoresByWorker.push(exports.TopicIdActorIdScore.decode(reader, reader.uint32()));
                    continue;
                }
                case 14: {
                    if (tag !== 114) {
                    ...
                    message.latestForecasterScoresByWorker.push(exports.TopicIdActorIdScore.decode(reader, reader.uint32()));
                    continue;
                }
                case 15: {
                    if (tag !== 122) {
                    ...
                    message.latestReputerScoresByReputer.push(exports.TopicIdActorIdScore.decode(reader, reader.uint32()));
                    continue;
                }
                case 16: {
                    if (tag !== 130) {
                ...
                case 20: {
                    ...
                    message.previousForecasterScoreRatio.push(exports.TopicIdActorIdDec.decode(reader, reader.uint32()));
                    continue;
                }
                case 21: {
                    if (tag !== 170) {
    ...
    fromJSON(object) {
        return {
            ...
            reputerScoresByBlock: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.reputerScoresByBlock)
                ...
                : [],
            latestInfererScoresByWorker: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.latestInfererScoresByWorker)
                ? object.latestInfererScoresByWorker.map((e) => exports.TopicIdActorIdScore.fromJSON(e))
                : [],
            latestForecasterScoresByWorker: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.latestForecasterScoresByWorker)
                ? object.latestForecasterScoresByWorker.map((e) => exports.TopicIdActorIdScore.fromJSON(e))
                : [],
            latestReputerScoresByReputer: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.latestReputerScoresByReputer)
                ? object.latestReputerScoresByReputer.map((e) => exports.TopicIdActorIdScore.fromJSON(e))
                : [],
            ...
            previousForecasterScoreRatio: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.previousForecasterScoreRatio)
                ? object.previousForecasterScoreRatio.map((e) => exports.TopicIdActorIdDec.fromJSON(e))
                : [],
    ...
    toJSON(message) {
        ...
        if ((_k = message.latestInfererScoresByWorker) === null || _k === void 0 ? void 0 : _k.length) {
            obj.latestInfererScoresByWorker = message.latestInfererScoresByWorker.map((e) => exports.TopicIdActorIdScore.toJSON(e));
        }
        if ((_l = message.latestForecasterScoresByWorker) === null || _l === void 0 ? void 0 : _l.length) {
            obj.latestForecasterScoresByWorker = message.latestForecasterScoresByWorker.map((e) => exports.TopicIdActorIdScore.toJSON(e));
        }
        if ((_m = message.latestReputerScoresByReputer) === null || _m === void 0 ? void 0 : _m.length) {
            obj.latestReputerScoresByReputer = message.latestReputerScoresByReputer.map((e) => exports.TopicIdActorIdScore.toJSON(e));
        }
        ...
        if ((_s = message.previousForecasterScoreRatio) === null || _s === void 0 ? void 0 : _s.length) {
            obj.previousForecasterScoreRatio = message.previousForecasterScoreRatio.map((e) => exports.TopicIdActorIdDec.toJSON(e));
        }
        if (message.totalStake !== "") {
        ...
        if ((_13 = message.unfulfilledWorkerNonces) === null || _13 === void 0 ? void 0 : _13.length) {
            obj.unfulfilledWorkerNonces = message.unfulfilledWorkerNonces.map((e) => exports.TopicIdAndNonces.toJSON(e));
        }
        if ((_14 = message.unfulfilledReputerNonces) === null || _14 === void 0 ? void 0 : _14.length) {
            obj.unfulfilledReputerNonces = message.unfulfilledReputerNonces.map((e) => exports.TopicIdAndReputerRequestNonces.toJSON(e));
        }
        if ((_15 = message.latestInfererNetworkRegrets) === null || _15 === void 0 ? void 0 : _15.length) {
        ...
        if ((_16 = message.latestForecasterNetworkRegrets) === null || _16 === void 0 ? void 0 : _16.length) {
        ...
        if ((_17 = message.latestOneInForecasterNetworkRegrets) === null || _17 === void 0 ? void 0 : _17.length) {
        ...
        if ((_18 = message.latestNaiveInfererNetworkRegrets) === null || _18 === void 0 ? void 0 : _18.length) {
        ...
        if ((_19 = message.latestOneOutInfererInfererNetworkRegrets) === null || _19 === void 0 ? void 0 : _19.length) {
        ...
        if ((_20 = message.latestOneOutInfererForecasterNetworkRegrets) === null || _20 === void 0 ? void 0 : _20.length) {
        ...
        if ((_21 = message.latestOneOutForecasterInfererNetworkRegrets) === null || _21 === void 0 ? void 0 : _21.length) {
        ...
        if ((_22 = message.latestOneOutForecasterForecasterNetworkRegrets) === null || _22 === void 0 ? void 0 : _22.length) {
        ...
        if ((_23 = message.coreTeamAddresses) === null || _23 === void 0 ? void 0 : _23.length) {
            obj.coreTeamAddresses = message.coreTeamAddresses;
        }
        if ((_24 = message.topicLastWorkerCommit) === null || _24 === void 0 ? void 0 : _24.length) {
            obj.topicLastWorkerCommit = message.topicLastWorkerCommit.map((e) => exports.TopicIdTimestampedActorNonce.toJSON(e));
        }
        if ((_25 = message.topicLastReputerCommit) === null || _25 === void 0 ? void 0 : _25.length) {
    ...
    fromPartial(object) {
        ...
        message.latestInfererScoresByWorker =
            ((_l = object.latestInfererScoresByWorker) === null || _l === void 0 ? void 0 : _l.map((e) => exports.TopicIdActorIdScore.fromPartial(e))) || [];
        message.latestForecasterScoresByWorker =
            ((_m = object.latestForecasterScoresByWorker) === null || _m === void 0 ? void 0 : _m.map((e) => exports.TopicIdActorIdScore.fromPartial(e))) || [];
        message.latestReputerScoresByReputer =
            ((_o = object.latestReputerScoresByReputer) === null || _o === void 0 ? void 0 : _o.map((e) => exports.TopicIdActorIdScore.fromPartial(e))) || [];
        ...
        message.previousForecasterScoreRatio =
            ((_t = object.previousForecasterScoreRatio) === null || _t === void 0 ? void 0 : _t.map((e) => exports.TopicIdActorIdDec.fromPartial(e))) || [];
        ...
        message.unfulfilledWorkerNonces = ((_16 = object.unfulfilledWorkerNonces) === null || _16 === void 0 ? void 0 : _16.map((e) => exports.TopicIdAndNonces.fromPartial(e))) || [];
        message.unfulfilledReputerNonces =
            ((_17 = object.unfulfilledReputerNonces) === null || _17 === void 0 ? void 0 : _17.map((e) => exports.TopicIdAndReputerRequestNonces.fromPartial(e))) || [];
        message.latestInfererNetworkRegrets =
            ((_18 = object.latestInfererNetworkRegrets) === null || _18 === void 0 ? void 0 : _18.map((e) => exports.TopicIdActorIdTimeStampedValue.fromPartial(e))) || [];
        message.latestForecasterNetworkRegrets =
            ((_19 = object.latestForecasterNetworkRegrets) === null || _19 === void 0 ? void 0 : _19.map((e) => exports.TopicIdActorIdTimeStampedValue.fromPartial(e))) || [];
        message.latestOneInForecasterNetworkRegrets =
            ((_20 = object.latestOneInForecasterNetworkRegrets) === null || _20 === void 0 ? void 0 : _20.map((e) => exports.TopicIdActorIdActorIdTimeStampedValue.fromPartial(e))) ||
                [];
        message.latestNaiveInfererNetworkRegrets =
            ((_21 = object.latestNaiveInfererNetworkRegrets) === null || _21 === void 0 ? void 0 : _21.map((e) => exports.TopicIdActorIdTimeStampedValue.fromPartial(e))) || [];
        message.latestOneOutInfererInfererNetworkRegrets =
            ((_22 = object.latestOneOutInfererInfererNetworkRegrets) === null || _22 === void 0 ? void 0 : _22.map((e) => exports.TopicIdActorIdActorIdTimeStampedValue.fromPartial(e))) || [];
        message.latestOneOutInfererForecasterNetworkRegrets =
            ((_23 = object.latestOneOutInfererForecasterNetworkRegrets) === null || _23 === void 0 ? void 0 : _23.map((e) => exports.TopicIdActorIdActorIdTimeStampedValue.fromPartial(e))) || [];
        message.latestOneOutForecasterInfererNetworkRegrets =
            ((_24 = object.latestOneOutForecasterInfererNetworkRegrets) === null || _24 === void 0 ? void 0 : _24.map((e) => exports.TopicIdActorIdActorIdTimeStampedValue.fromPartial(e))) || [];
        message.latestOneOutForecasterForecasterNetworkRegrets =
            ((_25 = object.latestOneOutForecasterForecasterNetworkRegrets) === null || _25 === void 0 ? void 0 : _25.map((e) => exports.TopicIdActorIdActorIdTimeStampedValue.fromPartial(e))) || [];
        message.coreTeamAddresses = ((_26 = object.coreTeamAddresses) === null || _26 === void 0 ? void 0 : _26.map((e) => e)) || [];
        message.topicLastWorkerCommit =
            ((_27 = object.topicLastWorkerCommit) === null || _27 === void 0 ? void 0 : _27.map((e) => exports.TopicIdTimestampedActorNonce.fromPartial(e))) || [];
        message.topicLastReputerCommit =
            ((_28 = object.topicLastReputerCommit) === null || _28 === void 0 ? void 0 : _28.map((e) => exports.TopicIdTimestampedActorNonce.fromPartial(e))) || [];
        return message;
    },
};
