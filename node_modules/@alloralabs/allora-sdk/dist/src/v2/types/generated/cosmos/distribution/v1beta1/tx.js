...
exports.MsgWithdrawDelegatorRewardResponse = {
    ...
    fromJSON(object) {
        return { amount: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.amount) ? object.amount.map((e) => coin_1.Coin.fromJSON(e)) : [] };
    },
    toJSON(message) {
        var _a;
        const obj = {};
...
class MsgClientImpl {
    ...
    WithdrawDelegatorReward(request) {
        ...
        return promise.then((data) => exports.MsgWithdrawDelegatorRewardResponse.decode(new wire_1.BinaryReader(data)));
    }
    WithdrawValidatorCommission(request) {
        ...
        return promise.then((data) => exports.MsgWithdrawValidatorCommissionResponse.decode(new wire_1.BinaryReader(data)));
    }
    ...
    DepositValidatorRewardsPool(request) {
        ...
        return promise.then((data) => exports.MsgDepositValidatorRewardsPoolResponse.decode(new wire_1.BinaryReader(data)));
    }
}
