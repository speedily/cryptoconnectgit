...
exports.VersionInfo = {
    ...
    fromJSON(object) {
        return {
            ...
            buildDeps: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.buildDeps)
    ...
    toJSON(message) {
        ...
        if ((_a = message.buildDeps) === null || _a === void 0 ? void 0 : _a.length) {
...
class ServiceClientImpl {
    ...
    GetNodeInfo(request) {
        ...
        return promise.then((data) => exports.GetNodeInfoResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetSyncing(request) {
        const data = exports.GetSyncingRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "GetSyncing", data);
        return promise.then((data) => exports.GetSyncingResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetLatestBlock(request) {
        ...
        return promise.then((data) => exports.GetLatestBlockResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetBlockByHeight(request) {
        ...
        return promise.then((data) => exports.GetBlockByHeightResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetLatestValidatorSet(request) {
        ...
        return promise.then((data) => exports.GetLatestValidatorSetResponse.decode(new wire_1.BinaryReader(data)));
    }
    GetValidatorSetByHeight(request) {
        ...
        return promise.then((data) => exports.GetValidatorSetByHeightResponse.decode(new wire_1.BinaryReader(data)));
    }
    ABCIQuery(request) {
        const data = exports.ABCIQueryRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "ABCIQuery", data);
        return promise.then((data) => exports.ABCIQueryResponse.decode(new wire_1.BinaryReader(data)));
    }
}
