...
exports.QueryServiceClientImpl = exports.QueryServiceServiceName = exports.QueryServiceEmissionInfoResponse = exports.QueryServiceEmissionInfoRequest = exports.QueryServiceInflationResponse = exports.QueryServiceInflationRequest = exports.QueryServiceParamsResponse = exports.QueryServiceParamsRequest = exports.protobufPackage = void 0;
/* eslint-disable */
const wire_1 = require("@bufbuild/protobuf/wire");
const types_1 = require("./types");
exports.protobufPackage = "mint.v5";
function createBaseQueryServiceParamsRequest() {
    return {};
}
exports.QueryServiceParamsRequest = {
    ...
    create(base) {
        return exports.QueryServiceParamsRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseQueryServiceParamsRequest();
        return message;
...
function createBaseQueryServiceParamsResponse() {
    return { params: undefined };
}
exports.QueryServiceParamsResponse = {
    ...
    create(base) {
        return exports.QueryServiceParamsResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        const message = createBaseQueryServiceParamsResponse();
...
function createBaseQueryServiceInflationRequest() {
    return {};
}
exports.QueryServiceInflationRequest = {
    encode(_, writer = new wire_1.BinaryWriter()) {
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.QueryServiceInflationRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseQueryServiceInflationRequest();
        return message;
...
function createBaseQueryServiceInflationResponse() {
    return { inflation: new Uint8Array(0) };
}
exports.QueryServiceInflationResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
    ...
    create(base) {
        return exports.QueryServiceInflationResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a;
        const message = createBaseQueryServiceInflationResponse();
...
function createBaseQueryServiceEmissionInfoRequest() {
    return {};
}
exports.QueryServiceEmissionInfoRequest = {
    encode(_, writer = new wire_1.BinaryWriter()) {
        return writer;
    },
    decode(input, length) {
    ...
    create(base) {
        return exports.QueryServiceEmissionInfoRequest.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(_) {
        const message = createBaseQueryServiceEmissionInfoRequest();
        return message;
...
function createBaseQueryServiceEmissionInfoResponse() {
    return {
        params: undefined,
        ecosystemBalance: "",
...
exports.QueryServiceEmissionInfoResponse = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.params !== undefined) {
            types_1.Params.encode(message.params, writer.uint32(10).fork()).join();
        }
    ...
    create(base) {
        return exports.QueryServiceEmissionInfoResponse.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        ...
        message.monthsAlreadyUnlocked = (_1 = object.monthsAlreadyUnlocked) !== null && _1 !== void 0 ? _1 : "";
        message.updatedMonthsUnlocked = (_2 = object.updatedMonthsUnlocked) !== null && _2 !== void 0 ? _2 : "";
        return message;
    },
};
exports.QueryServiceServiceName = "mint.v5.QueryService";
class QueryServiceClientImpl {
    ...
    Params(request) {
        const data = exports.QueryServiceParamsRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Params", data);
        return promise.then((data) => exports.QueryServiceParamsResponse.decode(new wire_1.BinaryReader(data)));
    }
    Inflation(request) {
        const data = exports.QueryServiceInflationRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "Inflation", data);
        return promise.then((data) => exports.QueryServiceInflationResponse.decode(new wire_1.BinaryReader(data)));
    }
    EmissionInfo(request) {
        const data = exports.QueryServiceEmissionInfoRequest.encode(request).finish();
        const promise = this.rpc.request(this.service, "EmissionInfo", data);
        return promise.then((data) => exports.QueryServiceEmissionInfoResponse.decode(new wire_1.BinaryReader(data)));
    }
}
