...
exports.EventRewardCurrentBlockEmission = exports.EventEcosystemTokenMintSet = exports.EventTokenomicsSet = exports.protobufPackage = void 0;
/* eslint-disable */
const wire_1 = require("@bufbuild/protobuf/wire");
exports.protobufPackage = "mint.v3";
...
function createBaseEventRewardCurrentBlockEmission() {
    return { blockHeight: "0", tokenAmount: "" };
}
exports.EventRewardCurrentBlockEmission = {
    encode(message, writer = new wire_1.BinaryWriter()) {
        if (message.blockHeight !== "0") {
            writer.uint32(8).uint64(message.blockHeight);
        }
    ...
    create(base) {
        return exports.EventRewardCurrentBlockEmission.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseEventRewardCurrentBlockEmission();
