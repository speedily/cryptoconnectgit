import { fetchIndexerApi } from "../utils/index.js";
...
export async function getFillByDepositTx(params) {
    ...
    try {
        ...
        if (data?.status === "filled" && data?.fillTx) {
            const fillTxReceipt = await params.destinationChainClient.getTransactionReceipt({
                hash: data.fillTx,
            });
...
export async function waitForFillByDepositTx(params) {
...
export async function getFillLogs(params) {
...
//# sourceMappingURL=getFillByDepositTx.js.map