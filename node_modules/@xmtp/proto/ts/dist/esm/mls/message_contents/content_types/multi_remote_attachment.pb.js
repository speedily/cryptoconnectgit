...
export const MultiRemoteAttachment = {
    encode(message, writer = _m0.Writer.create()) {
        for (const v of message.attachments) {
            RemoteAttachmentInfo.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.attachments.push(RemoteAttachmentInfo.decode(reader, reader.uint32()));
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            attachments: Array.isArray(object === null || object === void 0 ? void 0 : object.attachments)
                ? object.attachments.map((e) => RemoteAttachmentInfo.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.attachments) {
            obj.attachments = message.attachments.map((e) => e ? RemoteAttachmentInfo.toJSON(e) : undefined);
        }
        else {
            obj.attachments = [];
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseMultiRemoteAttachment();
        message.attachments =
            ((_a = object.attachments) === null || _a === void 0 ? void 0 : _a.map((e) => RemoteAttachmentInfo.fromPartial(e))) || [];
        return message;
    },
};
...
export const RemoteAttachmentInfo = {
    encode(message, writer = _m0.Writer.create()) {
