...
exports.GetInboxIdsRequest_Request = {
    ...
    fromJSON(object) {
        return {
            ...
            identifierKind: isSet(object.identifierKind)
                ? (0, association_pb_1.identifierKindFromJSON)(object.identifierKind)
                : 0,
        };
    },
    toJSON(message) {
        ...
        message.identifierKind !== undefined &&
            (obj.identifierKind = (0, association_pb_1.identifierKindToJSON)(message.identifierKind));
        return obj;
    },
    fromPartial(object) {
        var _a, _b;
        ...
        message.identifierKind = (_b = object.identifierKind) !== null && _b !== void 0 ? _b : 0;
        return message;
    },
};
...
exports.GetInboxIdsResponse_Response = {
    ...
    fromPartial(object) {
        ...
        message.identifierKind = (_c = object.identifierKind) !== null && _c !== void 0 ? _c : 0;
        return message;
    },
};
